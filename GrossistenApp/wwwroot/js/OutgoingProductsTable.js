...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function sortByColumn(index) {
        // Bestäm om sorteringen ska vara stigande eller fallande
        ...
        allFilterableRows.sort((a, b) => {
            ...
            // Försök att jämföra som numeriska värden
            const aNum = parseFloat(aText.replace(',', '.')); // Byt ut kommatecken för korrekt parse
            ...
            // Om det inte går att jämföra numeriskt, använd alfabetisk jämförelse
